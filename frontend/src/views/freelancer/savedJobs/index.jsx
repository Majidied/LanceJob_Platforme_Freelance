...
const SavedJobs = () => {
  ...
  return (
    <div className="flex flex-col h-full ">
      ...
      {/* Job Listings */}
      <div className="flex-1 w-full max-w-screen-xl p-4 mx-auto pt-11">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex mb-4 rounded-lg bg-[#F3F9FA] dark:!bg-navy-900">
                    ...
                    <div className="p-4 ml-auto">
                      <button className="px-6 py-2 text-white transition-colors duration-200 bg-[#86C1A3] rounded-md hover:bg-[#5f9478]">
                        Apply
                      </button>
                    </div>
                  </div>
