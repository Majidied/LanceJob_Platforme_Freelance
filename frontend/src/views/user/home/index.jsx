              ...
              <div className="text-center">
                <div className="relative w-20 h-20 mx-auto mb-4">
                  <div className="flex items-center justify-center w-full h-full bg-blue-100 rounded-full">
                    <img 
                      src={avatarUrls[selectedFreelancer.id] || `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedFreelancer.name)}&background=3b82f6&color=fff&size=200`}
                      alt="Profile" 
                      className="object-cover w-full h-full border-2 border-blue-500 rounded-full"
                      onError={(e) => {
                        e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedFreelancer.name)}&background=3b82f6&color=fff&size=200`;
                      }}
                    />
                  </div>
                  <div className="absolute w-6 h-6 bg-green-500 border-2 border-white rounded-full -bottom-1 -right-1"></div>
